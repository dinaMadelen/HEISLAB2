...
// Receiver listens for broadcasts on the specified port and updates the peer list.
// It sends updates to the peerUpdateCh channel whenever there are changes in the peer list.
